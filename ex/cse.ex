...
defproc toplevel (a1of1 go)
{
  ...
  (i:32: e_12.v[i] = tv_10[i].v;)
  (i:32: e_12.v[i] = rtv_10[i].v;)
  s_10.r.r = e_9.go_r;
  (i:32: s_10.r.r = rtv_10[i].go.r;)
  syn_ctree<32> ct_10;
  (i:32: ct_10.in[i] = rtv_10[i].go.a;)
  s_10.r.a = ct_10.out;
  (i:32: e_11.out[i].t = rtv_10[i].in.t;
         e_11.out[i].f = rtv_10[i].in.f;)
  s_10.go.a = e_12.go_r;
  syn_recv s_9[32];
  (i:32: s_9[i].go.r = c_6.r;)
  (i:32: s_9[i].in.t = e_12.out[i].t;
         s_9[i].in.f = e_12.out[i].f;
         s_9[i].v = var_w[i].v;)
  syn_ctree<32> ct_9;
